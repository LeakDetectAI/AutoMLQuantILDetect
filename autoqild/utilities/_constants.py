...
LOG_LOSS_MI_ESTIMATION_ISOTONIC_REGRESSION = (
    f"{LOG_LOSS_MI_ESTIMATION}{ISOTONIC_REGRESSION}"
)
...
LOG_LOSS_MI_ESTIMATION_HISTOGRAM_BINNING = (
    f"{LOG_LOSS_MI_ESTIMATION}{HISTOGRAM_BINNING}"
)
LOG_LOSS_MI_ESTIMATION_TEMPERATURE_SCALING = (
    f"{LOG_LOSS_MI_ESTIMATION}{TEMPERATURE_SCALING}"
)

PC_SOFTMAX_MI_ESTIMATION_ISOTONIC_REGRESSION = (
    f"{PC_SOFTMAX_MI_ESTIMATION}{ISOTONIC_REGRESSION}"
)
PC_SOFTMAX_MI_ESTIMATION_PLATT_SCALING = f"{PC_SOFTMAX_MI_ESTIMATION}{PLATT_SCALING}"
PC_SOFTMAX_MI_ESTIMATION_BETA_CALIBRATION = (
    f"{PC_SOFTMAX_MI_ESTIMATION}{BETA_CALIBRATION}"
)
PC_SOFTMAX_MI_ESTIMATION_HISTOGRAM_BINNING = (
    f"{PC_SOFTMAX_MI_ESTIMATION}{HISTOGRAM_BINNING}"
)
PC_SOFTMAX_MI_ESTIMATION_TEMPERATURE_SCALING = (
    f"{PC_SOFTMAX_MI_ESTIMATION}{TEMPERATURE_SCALING}"
)
